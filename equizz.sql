...
--
-- Host: localhost    Database: equizz
-- ------------------------------------------------------
...
--
-- Table structure for table `quizz results`
--

DROP TABLE IF EXISTS `quizz results`;
...
CREATE TABLE `results` (
  `Quizz name` tinytext NOT NULL,
  `Quizz number` int unsigned NOT NULL,
  `Date` date NOT NULL,
  `Student group` varchar(25) NOT NULL,
  `Student` varchar(15) NOT NULL,
  `Question` tinytext NOT NULL,
  `Answer submitted` tinytext,
...
-- Dump completed on 2023-01-08 16:52:34
